...
*Study*
{
	...
	{ 0x0010, 0x0010, "PatientName", 64, SQL_C_CHAR, DT_STR },
        { 0x0010, 0x0030, "PatientBirthDate", 8, SQL_C_DATE, DT_DATE },
	{ 0x0010, 0x0040, "PatientSex", 16, SQL_C_CHAR, DT_STR },
	{ 0x0008, 0x1070, "OperatorsName", 128, SQL_C_CHAR, DT_STR },
	{ 0x0010, 0x0020, "PatientID", 64, SQL_C_CHAR, DT_STR }
...
*Series*
{
	...
	{ 0x0008, 0x1090, "ManModelName", 256, SQL_C_CHAR, DT_STR },
	...
	{ 0x0028, 0x0008, "NumberOfFrames", 64, SQL_C_CHAR, DT_UI },
	{ 0x3004, 0x000A, "DoseSummationType", 64, SQL_C_CHAR, DT_UI },
	{ 0x3006, 0x0002, "StructureSetLabel",64, SQL_C_CHAR, DT_UI },
...
*Image*
{
	...
	{ 0x0028, 0x0030, "PixelSpacing", 64, SQL_C_CHAR, DT_STR },
	{ 0x0028, 0x0101, "BitsStored", 5, SQL_C_CHAR, DT_UINT16 },
	{ 0x0028, 0x1052, "RescaleIntercept", 64, SQL_C_CHAR, DT_STR},
	{ 0x0028, 0x1053, "RescaleSlope", 64, SQL_C_CHAR, DT_STR },
	...
	{ 0x0018, 0x0060, "KVP", 64, SQL_C_CHAR, DT_STR },
	{ 0x0018, 0x1150, "ExposureTime", 64, SQL_C_CHAR, DT_STR },
	{ 0x0018, 0x1151, "TubeCurrent", 64, SQL_C_CHAR, DT_STR },
    { 0x0018, 0x1152, "Exposure", 64, SQL_C_CHAR, DT_STR },
	{ 0x0018, 0x9345, "CTDIvol", 64, SQL_C_CHAR,  DT_FD },
	{ 0x01F1, 0x1026, "Pitch", 64, SQL_C_CHAR,  DT_STR },
	{ 0x01F1, 0x1027, "RotationTime", 64, SQL_C_CHAR,  DT_STR },
	{ 0x01F1, 0x104A, "DoseRight", 64, SQL_C_CHAR,  DT_STR },
	{ 0x01F1, 0x104B, "Collimation", 64, SQL_C_CHAR,  DT_STR },
    { 0x0018, 0x0050, "SliceThickness", 64, SQL_C_CHAR, DT_STR },
